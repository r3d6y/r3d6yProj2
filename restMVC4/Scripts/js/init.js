$(function(){
		...
		$('#fullpage').fullpage({
			anchors: ['Главная', 'Ресторан', 'Предложения', 'Новости', 'Контакты','Карта'],
		...
		var BlurBGImage	= (function() {
                    ...
                    $title				= $bxWrapper.find('.bx-content:first'),
                    ...
                    animOptions			= { speed : 400, variation : 2, blurFactor : 10 },
                    ...
                    showImage			= function( pos ) {
                        ...
                        if( supportCanvas ) {
                            ...
                            $.when( $title.fadeOut() ).done( function() {
                                ...
                                $title.find('h2').text( $bxNextImage.attr('title') );
